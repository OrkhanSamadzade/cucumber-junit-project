...
public class WebTableOrder_StepDefs {
    ...
    public void user_is_already_logged_in_and_on_order_page() {
        Driver.getDriver().get(ConfigurationReader.getMyProperty("env"));
        webTableLoginPage.login(ConfigurationReader.getMyProperty("username"),ConfigurationReader.getMyProperty("password"));
    ...
    public void user_enters_quantity(Integer int1) {
        webTableOrderPage.inputQuantity.click();
...
//        }
    ...
    public void user_should_see_in_first_row_of_the_web_table(String exceptedCustomerName) {
    String actualCustomerName = viewAllOrdersPage.newCustomerCell.getText();

        Assert.assertEquals(exceptedCustomerName, actualCustomerName);
    }
